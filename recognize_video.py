...
# ap.add_argument("-e", "--height", type=int, default=600,
...
while True:
	...
	# imageBlob = cv2.dnn.blobFromImage(frame, 1.0,(300, 300),(123.68, 116.78, 103.94), swapRB=False, crop=False)

	# imageBlob = cv2.dnn.blobFromImage(frame, 1.0, (newW, newH), (123.68, 116.78, 103.94), swapRB=True, crop=False)
